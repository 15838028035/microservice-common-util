 ...
 * 定时任务监控扩展类，建议使用不要直接使用，建议使用ThreadPoolTaskExecutorMonitor
 */
...
public class ThreadPoolTaskExecutorExt extends ThreadPoolTaskExecutor
    ...
    protected ExecutorService initializeExecutor(
        ...
        ThreadPoolMonitor executor;
        if (this.taskDecorator != null) {
            executor = new ThreadPoolMonitor(
        ...
        this.threadPoolExecutor = (ThreadPoolMonitor) executor;
        return executor;
    }
